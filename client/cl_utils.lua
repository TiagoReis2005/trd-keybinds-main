...
local BINDSTRING = {
  ...
  function realKeyString(rawKeyString)
    local normalKey = string.gsub(rawKeyString, "^t_", "")
    if normalKey ~= rawKeyString then
      return normalKey
    elseif BINDSTRING[rawKeyString] then
      return BINDSTRING[rawKeyString]
    else
      return rawKeyString
    end
  end